...
to setup
 ...
 [
   ...
   ; Set initial location of butterflies
    if location = "cluster1"
     [
      set ycor 105 + random(10)
      set xcor 105 + random(10)
     ]
    if location = "cluster2"
     [
      set ycor 70 + random(10)
      set xcor 30 + random(10)
     ]
    if location = "cluster3"
     [
      set ycor 30 + random(10)
      set xcor 30 + random(10)
     ]
    if location = "cluster4"
     [
      set ycor 30 + random(10)
      set xcor 105 + random(10)
     ]
...
to go ; This is the master schedule
  ...
  [
    ...
    output-print word "Corridor width: " precision final-corridor-width 5
    ;output-print precision final-corridor-width 5
    stop
  ]
...
to move ; The butterfly move procedure, in turtle context
 ...
 if movement = "any higher neighbor" [
  ifelse random-float 1 < q
    [
      let el elevation
      let p one-of neighbors with [elevation >= el]
      if p != nobody
      [
       face p
       move-to p
...
to setup-terrain-2
  ...
  resize-world 0 201 0 153

  file-open "terrain2.txt"
  while [not file-at-end?]
  [
    let next-X file-read
    let next-Y file-read
...
to-report corridor-width
  ...
  report visited-patches / (mean-distance + 0.0000001)

end

to-report clumps
  report count patches with [any? turtles-here]
end
...
location
location
"random" "cluster1" "cluster2" "cluster3" "cluster4" "corner"
1
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>clumps</metric>
    <metric>corridor-width</metric>
    <enumeratedValueSet variable="movement">
      <value value="&quot;uphill&quot;"/>
      <value value="&quot;any higher neighbor&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="location">
      <value value="&quot;cluster1&quot;"/>
      <value value="&quot;cluster2&quot;"/>
      <value value="&quot;cluster3&quot;"/>
      <value value="&quot;cluster4&quot;"/>
      <value value="&quot;random&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="color-terrain">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="terrain">
      <value value="&quot;terrain 1&quot;"/>
    </enumeratedValueSet>
